...
$konbuCommand = "ssh -A $innerSshOptions $GpuHost ""sh -lc '$remoteCommand'"""
...
for ($attempt = 1; $attempt -le $RetryCount; $attempt++) {
    ...
    $base64 = ssh -A -o ConnectTimeout=$ConnectTimeout -o ServerAliveInterval=30 -o ServerAliveCountMax=3 -J $JumpHost $KonbuHost $konbuCommand
